...
SplashPath *SplashFTFont::getGlyphPath(int c) {
  static FT_Outline_Funcs outlineFuncs = {
    (FT_Outline_MoveToFunc)(&glyphPathMoveTo),
    (FT_Outline_LineToFunc)(&glyphPathLineTo),
    (FT_Outline_ConicToFunc)(&glyphPathConicTo),
    (FT_Outline_CubicToFunc)(&glyphPathCubicTo),
    0, 0
  };
  SplashFTFontFile *ff;
