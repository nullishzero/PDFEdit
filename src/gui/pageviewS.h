...
class PageViewS : public QScrollView {
	...
	public:
		...
		/** Function return X,Y position in pdf page from position of viewed page on screen (unapply rotation, viewing dpi, ...)
		...
		/** Function return X,Y position on viewed page from position in pdf page (apply rotation, viewing dpi, ...)
